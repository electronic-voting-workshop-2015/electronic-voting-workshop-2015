...
public class MyBiprtiteGraph extends bipartiteGraph
{
	...
	public MyBiprtiteGraph(int numberOfVerticesLeft, int numberOfVerticesRight) 
	{
		super(numberOfVerticesLeft, numberOfVerticesRight);
