...
//import MixnetVerifierUtils.MixnetProofs.Layer.AndProof.OrProof;
...
public class RunMixnet {
	...
	public static void InitializeGroupInfo()
	{
        ...
        int integerSize = 256 / 8; // IT WAS 8
	...
	*/
	...
	public static void main(String[] args) throws JSONException {
		...
		CreateJson.stringToFile(filepath, s);
		...
		//System.out.print("Enter proof name: ");
		//filepath = "./P" + in.next() + ".json";
		in.close();
		...
		try {
			CreateJson.createJsonFile(filepath, n, codes, ArrayAndProf.ProofToString(n));
		...
		/**/
		try {
			ExecuteShellCommand.sendWithPOST(filepath, "http://46.101.148.106:4567/publishProofsFile");
		} catch (Exception e) {
			e.printStackTrace();
		}
